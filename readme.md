...
| `Alt` + `L`            | Focus the Item List                                                                                                                                   |
| `Enter`                | Copy selected item and paste into the previously focused application if the selection is on the list. If it is on the Search Input focus on the List. |
